(function($) {
  (function() {
    ...
    var db = {
      ...
      loadData: function(filter) {
        return $.grep(this.clients, function(client) {
          return (!filter.RUC || client.RUC.indexOf(filter.RUC) > -1) &&
            (filter.Razon === undefined || client.Razon === filter.Razon) &&
            (!filter.Contacto || client.Contacto.indexOf(filter.Contacto) > -1) &&
            (!filter.Mail || client.Mail === filter.Mail) &&
            (filter.Telefono === undefined || client.Telefono === filter.Telefono);
        });
      },
    ...
    db.clients = [{
        RUC: "9999999999999",
        Razon: "Mathias Espinoza",
        Contacto: "099999",
        Mail: "william@hotmail.com",
        Telefono: "048609",
        auditoria:1
      },
      {
